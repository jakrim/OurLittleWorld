-- Re-run the controlled QA upsert with explicit audience-access diagnosis.
...
begin
  ...
  if qa_contact_id is null
     or not public.enqueue_marketing_contact_sync(
       qa_contact_id,
       'olw_internal_qa_provider_access_probe_20260713',
       'upsert'
     ) then
    raise exception using
      errcode = 'P0001',
      message = 'internal_qa_provider_probe_not_queued';
  end if;
end
$$;
