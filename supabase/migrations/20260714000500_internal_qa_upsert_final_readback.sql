-- Final readback after the asynchronous edge invocation has had time to settle.
...
begin
  ...
  raise notice 'internal_qa_final_provider=%', qa_provider;
  raise notice 'internal_qa_final_contact_job=%', qa_contact_job;
  raise notice 'internal_qa_final_lifecycle=%', qa_lifecycle;
  raise notice 'internal_qa_final_dispatch=%', dispatch_status;
  raise notice 'internal_qa_final_lifecycle_health=%', public.marketing_lifecycle_health();
end
$$;
