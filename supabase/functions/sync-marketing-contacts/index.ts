...
import { syncMarketingContacts } from '../_shared/marketing.ts';
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (Number(health?.dead_letter_count || health?.blocked_count || 0) > 0) {
      ...
      console.log('marketing_sync_completed', counts);
    }
