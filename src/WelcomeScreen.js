...
const SLIDES = [
  {
    ...
    title: "Your baby's story,\nkept from the very\nbeginning.",
    body: 'Capture the first days, the tiny routines, and the details that blur together when life gets full.',
  },
  {
    key: 'details',
    art: 'details',
    ...
    title: 'First smiles,\nsleepy notes,\nordinary magic.',
    body: 'Save photos, milestones, funny habits, late-night thoughts, and the small moments you will want to replay.',
  },
  {
    key: 'growth',
    art: 'growth',
    ...
    body: 'From newborn days to first steps and beyond, build a shared record of who they are becoming.',
  },
  {
    key: 'private',
    art: 'private',
    eyebrow: 'Private for family',
    title: 'Made for the two\nof you, not the\ninternet.',
    body: 'Invite your partner, keep everything in one quiet place, and leave the feeds, likes, and algorithm outside.',
  },
];
